...
class TestGetCurrentPriceTool:
    ...
    @pytest.mark.asyncio
    async def test_execute_with_paper_engine(self, init_db):  # noqa: ARG002
...
class TestGetPortfolioStateTool:
    ...
    @pytest.mark.asyncio
    async def test_execute_returns_portfolio_data(self, init_db):  # noqa: ARG002
...
class TestGetBalanceTool:
    ...
    @pytest.mark.asyncio
    async def test_execute_returns_balance(self, init_db):  # noqa: ARG002
    ...
    @pytest.mark.asyncio
    async def test_execute_with_specific_currency(self, init_db):  # noqa: ARG002
...
class TestGetPositionsTool:
    ...
    @pytest.mark.asyncio
    async def test_execute_returns_empty_list(self, init_db):  # noqa: ARG002
    ...
    @pytest.mark.asyncio
    async def test_execute_returns_positions(self, init_db):  # noqa: ARG002
...
class TestPerceptionToolsIntegration:
    ...
    @pytest.mark.asyncio
    async def test_tools_can_be_executed_through_toolkit(self, init_db):  # noqa: ARG002
