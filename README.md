...
> **Want the full walkthrough?** See the [Development Guide](docs/development.md) for setup instructions, or the [Configuration Reference](docs/configuration.md) for all settings.
